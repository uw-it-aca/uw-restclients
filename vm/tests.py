...
from vm.v1.test.message_type import MessageTypeTest
from vm.v1.test.person import PersonTest
from vm.v1.test.subscription import SubscriptionDetailViewModelTest
